import { localGetAIResponse } from "./localAiService.js";

// ── Main export ───────────────────────────────────────────────────
// Uses self-contained backend AI (FAQ matching + knowledge base search)
export const getAIResponse = async (messages, systemPrompt = "", chatbot = null) => {
  return await localGetAIResponse(messages, systemPrompt, chatbot);
};

// ── 3rd Party APIs (commented out — kept for reference) ───────────
...
// // To restore 3rd party fallback chain:
